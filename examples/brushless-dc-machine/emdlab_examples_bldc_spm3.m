...
gv_p = 8; % number of rotor poles
gv_wst = 10; % width of stator tooth [mm]
...
emdlab_g2d_lib_tc21(g, gv_ISD, gv_OSD, gv_Ns, gv_wst, gv_dss, gv_bs0, gv_hs0, gv_tta,1, 'stator', 'sc', 'sap');
emdlab_g2d_lib_rm_spm3(g, gv_Dsh, gv_ISD, gv_gap, gv_gg, gv_Nagl, gv_p, gv_dm, gv_embrace, 'rotor', 'magnet', 'rap');
...
for i = 1:2:gv_p
    ...
    s.setMagnetization(['magnet',num2str(i)],gv_Hc,u_mag);
