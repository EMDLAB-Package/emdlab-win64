...
function emdlab_g2d_lib_tc3(g, ID, OD, Ns, wst, dss, bs0, hs0, tta, name1, name2, name3)
...
u3 = [ux,uy];
    ...
    function err = err_fcn(r)
        [xtmp,ytmp] = emdlab_g2d_getLineLineIntersection([0,-wst*0.5/cos(alpha_s/2)], u2, [ID/2+dss-r,0], u3);
        r2 = norm([xtmp,ytmp]-[ID/2+dss-r,0]);
        err = r2-r;
    end

r = fzero(@err_fcn,1);
[x4,y4] = emdlab_g2d_getLineLineIntersection([0,-wst*0.5/cos(alpha_s/2)], u2, [ID/2+dss-r,0], u3);
