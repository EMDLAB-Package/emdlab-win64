...
function emdlab_g2d_lib_tc121(g, wst, wss, dsy, dss, xShift, yShift, mirrorFlag, name1, name2)
...
[e9, p8] = g.splitSegment(e4);
[e10, p9] = g.splitSegment(e7);
e11 = g.addSegment(p9,p8);

if mirrorFlag
    l1 = g.addLoop(-e6,-e5,-e9,-e4,-e3,-e2,-e1);
    l2 = g.addLoop(e3,e4,-e11,-e7);
    l3 = g.addLoop(e11,e9,-e8,-e10);
else
    l1 = g.addLoop(e1,e2,e3,e4,e9,e5,e6);
    l2 = g.addLoop(e7,e11,-e4,-e3);
    l3 = g.addLoop(e10,e8,-e9,-e11);
end
...
g.setFaceColor(name2 + "1", 255, 137, 39);
g.setFaceColor(name2 + "2", 255, 137, 39);
