...
function emdlab_g2d_lib_tc21(g, ISD, OSD, Ns, wst, dss, bs0, hs0, tta, bw0, name1, name2, name3)
...
[x5,y5] = g.getIntersectionLineLine(x6,y6,-sin(alpha_s/2),cos(alpha_s/2),x11,y11,cos(alpha_s/2),sin(alpha_s/2));
