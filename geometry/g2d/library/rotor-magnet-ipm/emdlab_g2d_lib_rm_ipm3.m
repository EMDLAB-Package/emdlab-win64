...
function emdlab_g2d_lib_rm_ipm3(g, ID, OD, p, dm, wtrib, wrrib, bm0, t0, name1, name2, name3)
...
err_fcn = @(t) abs(sqrt(r^2 - (y9 + t*uy)^2) - (x9 + t*ux) - dm);
t = fminbnd(err_fcn,0,ID/2);

x7 = (x9 + t*ux);
y7 = (y9 + t*uy);

[x8,y8] = g.getIntersectionRayCircle(x7,y7,1,0,0,0,r);
