...
function emdlab_g2d_lib_rm_ipm4(g, ID, OD, p, dm, wtrib, wrrib, bm0, t0, t1, name1, name2, name3)
...
% checks for t0 & t1
if (t0 == 0) && (t1 == 0)
    emdlab_g2d_lib_rm_ipm1(g, ID, OD, p, dm, wtrib, wrrib, bm0, name1, name2, name3);
    return;
elseif (t0 > 0) && (t1 == 0)
    emdlab_g2d_lib_rm_ipm2(g, ID, OD, p, dm, wtrib, wrrib, bm0, t0, name1, name2, name3);
    return;
elseif (t0 == 0) && (t1 > 0)
    emdlab_g2d_lib_rm_ipm3(g, ID, OD, p, dm, wtrib, wrrib, bm0, t1, name1, name2, name3);
    return;
end
...
[x8,y8] = g.getIntersectionRayCircle(x7 + dm,y7,cos(alpha_p/2),sin(alpha_p/2),0,0,r);
...
if wrrib == 0
    ...
    e8 = g.addSegment(p11,p8);
    e9 = g.addSegment(p11,p10);
    e10 = g.addSegment(p7,p10);
    e11 = g.addSegment(p10,p2);
    e12 = g.addArc(o,p8,p9,1);
    e13 = g.addSegment(p9,p7);

    l1 = g.addLoop(e1,-e11,-e10,-e13,-e12,-e8,-e7,e3,e4,e5,e6);
    l2 = g.addLoop(e2,e7,e9,e11);
    l3 = g.addLoop(e8,e12,e13,e10,-e9);
    ...
    e6 = g.addSegment(p3,p11);
    e7 = g.addSegment(p11,p8);
    e8 = g.addSegment(p11,p10);
    e9 = g.addSegment(p7,p10);
    e10 = g.addSegment(p10,p2);
    e11 = g.addArc(o,p8,p9,1);
    e12 = g.addSegment(p9,p7);

    l1 = g.addLoop(e1,e2,e3,e4);
    l2 = g.addLoop(e5,e6,e7,e11,e12,e9,e10);
    l3 = g.addLoop(e5,e6,e8,e10);
    l4 = g.addLoop(e7,e11,e12,e9,-e8);
