...
function emdlab_g2d_lib_rm_ipm16(g, ID, OD, p, dm1, dm2, alpha_v, g_v, wtrib, wrrib, d0, d1, name1, name2, name3)
...
if wrrib == 0
    ...
    l1 = g.addLoop(e1,-e14,-e12,-e13,-e10,e3,-e20,-e17,-e19,-e15,e5,e6,e7,e8);
