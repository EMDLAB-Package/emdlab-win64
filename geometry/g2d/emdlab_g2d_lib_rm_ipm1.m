...
function emdlab_g2d_lib_rm_ipm1(g, ID, OD, p, dm, wtrib, wrrib, bm0, name1, name2, name3)
...
if wrrib == 0
    ...
    e10 = g.addArc(o,p8,p9,1);
    e11 = g.addSegment(p9,p7);

    l1 = g.addLoop(e1,-e9,-e11,-e10,-e7,e3,e4,e5,e6);
    l2 = g.addLoop(e2,e7,e8,e9);
    l3 = g.addLoop(-e8,e10,e11);
