function emdlab_m3d_lib_body2(m, pts1, pts2, p)
...
n = 10;
a = atan2(pts2(1,2),pts2(1,1))/n;

ol= [];
r_tmp = pts2(end,1) + p.housingT;
for i = 1:n
    z = g.addArcByCoordinatesCPA(0,0,r_tmp*cos((i-1)*a),r_tmp*sin((i-1)*a),a);
    e = g.addRectangularFinOnArc(z, 3, 8);
    g.addFace("fin"+string(i), g.addLoop(e(4), e(5), e(6), -e(2)));
ol = [ol,e(1:3)];
end

g.addFace('z1', g.addLoop([s,ol]));
...
m.addMeshZone('fin', tm.mzs.fin.buildPrismMeshByExtrusion1(z1));
...
m.joinMeshZones('housing', 'housing', 'fin')
